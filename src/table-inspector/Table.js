...
const DefaultTRComponent = ({rowId, ...props})=><tr {...((false && rowId)||props)}/>;
const DefaultTHComponent = ({columnId, ...props})=><th  {...((false && columnId)||props)}/>;
const DefaultTDComponent = ({rowId, columnId, ...props})=><td  {...((false && rowId && columnId)||props)}/>;
