...
const HeaderContainer = ({ indexColumnText, columns, sorted, sortIndexColumn, sortColumn, sortAscending, onTHClick, onIndexTHClick }, { theme }) => {
      ...
      {/*
        ...
        <tbody>
          <tr>
            ...
            {
              columns.map((column) => (
                <TH  borderStyle={borderStyles.solid}
                    key={column}
